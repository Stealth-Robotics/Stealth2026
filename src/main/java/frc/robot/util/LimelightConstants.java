...
public class LimelightConstants {
    ...
    public static final Vector<N3> VISION_STDDEVS = VecBuilder.fill(0.1, 0.1, Double.MAX_VALUE);
    ...
    public static final int MIN_TAG_COUNT_REJECTION = 1; //TODO: Either 0 or 1
