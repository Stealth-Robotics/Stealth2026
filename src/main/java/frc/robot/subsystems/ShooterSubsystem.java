...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        ...
        shooterConfig.CurrentLimits.StatorCurrentLimit = SHOOTER_SUPPLY_LIMIT;
        ...
        hoodConfig.CurrentLimits.StatorCurrentLimit = HOOD_SUPPLY_LIMIT;
    ...
    public boolean isShooterAtVelocity() {
        double rpm = Math.min(getRPM(), MAX_POSSIBLE_RPM);
        return Math.abs(rpm - Math.min(getTargetRPM(), MAX_POSSIBLE_RPM)) < SHOOTER_VELOCITY_TOLERANCE_RPM;
    }
    ...
    private double getRPM(boolean refresh) {
        return shooterMotor1.getVelocity(refresh).getValueAsDouble() * 60.0;
    }
